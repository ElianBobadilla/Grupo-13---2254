            ...
            <div class="global-container">
                <div class="registro-container col-lg-5 bg-dark d-flex  justify-content-evenly">
                    <div class="align-self-center w-100 px-lg-5 py-lg-4 p-4">
                        <h1 class="font-weight-bold mb-4"> Gestión de Paquetes - Registro de ordenes</h1>    
                        ...
                        <h1></h1>
                            <div class="col-12">
                                <button type="submit" class="btn btn-outline-secondary text-dark font-weight-bold rounded-3">Crear orden</button>
                            </div>
                        </form>       
                    </div> 
                </div>
